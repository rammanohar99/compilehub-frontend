...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 shrink-0 flex flex-col h-screen bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700">
      {/* Logo */}
      <div className="flex items-center gap-2.5 px-5 h-14 border-b border-gray-200 dark:border-gray-700 shrink-0">
      ...
      {/* Bottom section */}
      <div className="px-3 pb-4 space-y-1 border-t border-gray-200 dark:border-gray-700 pt-3 shrink-0">
        {/* Theme toggle */}
        <button
          onClick={toggle}
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white transition-all duration-150"
        >
          {theme === 'dark' ? (
        ...
        {/* User info + logout */}
        <div className="flex items-center gap-2.5 px-3 py-2.5 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
